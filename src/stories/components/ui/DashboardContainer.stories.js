    ...
    children: (
      <>
        ...
        <div style={{ 
          ...
          <div>
            <p style={{ fontSize: '0.75rem', color: '#9ca3af', fontWeight: '600' }}>TOTAL</p>
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>1.234</p>
          </div>
          <div>
            <p style={{ fontSize: '0.75rem', color: '#9ca3af', fontWeight: '600' }}>MACHOS</p>
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>589</p>
          </div>
          <div>
            <p style={{ fontSize: '0.75rem', color: '#9ca3af', fontWeight: '600' }}>FÊMEAS</p>
